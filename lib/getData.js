...
var Getter = function () {
    ...
    /**
     * Constructor
     * @param {String|Object}   url See core HTTP module documentation for options
    ...
    Getter.prototype.get = function() {
        this.raw = '';
        this.connection = http.get(this.url, this.handler.bind(this))
